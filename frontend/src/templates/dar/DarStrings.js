...
export const DAR_STRINGS = {
    fr: {
        ...
        rsvp: {
            ...
            hint: 'Dites-nous si vous serez des nôtres',
            accept: 'Nous serons présents',
            acceptSub: 'avec grande joie',
            decline: 'Avec tout notre regret',
            declineSub: 'nos cœurs seront avec vous',
            confirmYes: (name) => `Quelle joie, ${name} ! Votre place est réservée, la famille vous attend. Marhba !`,
    ...
    ar: {
        ...
        rsvp: {
            ...
            hint: 'أخبرونا إن كنتم ستشاركوننا الفرح',
            accept: 'حاضرون بكل فرح',
            acceptSub: 'إن شاء الله',
            decline: 'معذرة منكم',
            declineSub: 'قلوبنا معكم',
            confirmYes: (name) => `تزيدنا فرحة بفرحتكم يا ${name}، مكانكم محجوز والعائلة في انتظاركم. مرحبا!`,
